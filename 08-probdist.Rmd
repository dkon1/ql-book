# (PART) Randomness in observations {-} 
...
```{r fig-unif-dist, fig.show ='hold', echo=FALSE, out.width='50%', fig.asp=.75, fig.align='center', fig.cap = 'Two uniform random distributions with integer values with different ranges.'}
n <- 4
unif.dist <- rep(1/n,n)
values <- 0:(n-1)
...
```{r fig-bin-dist-1, echo=FALSE, out.width='50%', fig.asp=.75, fig.align='center', fig.show='hold', fig.cap = 'The binomial distribution for $n=2$ and $p=0.2$ and $p=0.5$ (you should be able to tell which one is which!)'}
n <- 2
p<-0.2
values <- 0:n
...
```{r fig-bin-dist-2, echo=FALSE, out.width='50%', fig.asp=.75, fig.align='center', fig.show='hold',fig.cap = 'The binomial distribution for $n=5$ and $p=0.2$ and $p=0.5$ (you should be able to tell which one is which!)'}
n <- 5
p<-0.2
values <- 0:n
prob.dist <- dbinom(values,n,p)
...
```{r fig-bin-dist-3, echo=FALSE, out.width='50%', fig.asp=.75, fig.align='center', fig.show='hold', fig.cap = 'The binomial distribution for $n=50$ and $p=0.2$ and $p=0.5$ (you should be able to tell which one is which!)'}
n <- 50
p<-0.2
values <- 0:n
prob.dist <- dbinom(values,n,p)
...
```{r fig-bin-dist-4, echo=TRUE, fig.show='hold', out.width='50%', fig.asp=.75, fig.align='center', fig.cap = 'The binomial distribution for two different values of n and p produced using dbinom() function.'}
values.vec <- 0:n
