...
![Three examples of two events inside a sample space with different probabilities: mutually exclusive, partially overlapping, and completely overlapping](ch6/indep_ex1.png) 
(ch6/indep_ex2.png)(ch6/indep_ex3.png)
