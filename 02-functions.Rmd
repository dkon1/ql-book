...
**Definition:** A \index{function!mathematical} function is a mathematical rule which has an input and an output. A function returns a well-defined output for every input, that is, for a given input value the function returns a unique output value.
...
**Definition** A \index{function!linear}\index{linear!function} linear function $f(x)$ is one for which the difference in two function values is the same for a specific difference in the independent variable. 
...
**Definition** An \index{exponential!function}\index{function!exponential}exponential function $f(x)$ is one for which the ratio of two function values is the same for a specific difference in the independent variable. 
...
```{r ch2-plot1, echo=TRUE, fig.show='hold', out.width='50%', fig.asp=.75, fig.align='center', fig.cap = 'Two examples of plots using curve: quadratic ($y=x^2$) and exponential ($y=20*e^{-0.5x}$)'}
...
```{r ch2-plot2, echo=TRUE, fig.show='hold', out.width='50%', fig.asp=.75, fig.align='center', fig.cap = 'Overlaying multiple plots in R: two exponential functions of the form $y=b+ae^{rx}$ on the left, two logistic functions of the form $y= ae^{rx}/(b+e^{rx})$ on the right.'}
x<-seq(0,10,0.5)
y<-10+20*exp(-0.5*x)
