...
\node[s1t] (s11) [below = of t1] {$1*0.95+0*0.1$};
\node[s2t] (s21) [below = of s11] {$0*0.9+1*0.05$};
\node[s1t] (s12) [below = of t2] {$0.95*0.95+0.05*0.1$};
\node[s2t] (s22) [below = of s12] {$0.95*0.05+0.05*0.9$};
